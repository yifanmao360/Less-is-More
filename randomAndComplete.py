...
if __name__ == "__main__":
    ...
    for i in range(2*246):
        if i%2 == 0:
            ...
            p2.append(toplot[i])
    plt.boxplot(p1)
    plt.vlines(94, 0, 1.2, linestyles = '-')
    plt.vlines(94+83, 0, 1.2, linestyles = '-')
    plt.vlines(94+83+37, 0, 1.2, linestyles = '-')
    plt.vlines(94+83+37+11, 0, 1.2, linestyles = '-')
    plt.vlines(94+83+37+11+12, 0, 1.2, linestyles = '-')
    plt.text(94/2-4, 1, r'Europe')
    plt.text(94+83/2-4, 1, r'North America')
    plt.text(94+83+37/2, 1, r'Asia')
    plt.text(94+83+37+11/2-2.5, 1, r'South America')
    plt.text(94+83+37+11+12/2-1, 1, r'Africa')
    plt.text(94+83+37+11+12+9, 1, r'Australia')
    plt.xlim(0, 260)
    plt.ylim(0,1.4)
    #plt.xaxis.set_major_locator(MultipleLocator(50))
    plt.grid(False)
    ax=plt.gca()
    ...
    #plt.xaxis.set_major_locator(MultipleLocator(50))
            ...
            #plt.legend()
            #c = c+1
    plt.savefig("randomandcomplete.png")
